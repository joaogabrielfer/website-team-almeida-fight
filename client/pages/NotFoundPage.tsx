...
export function NotFoundPage({ default: isDefault }: { default?: boolean }) {
    ...
    <PageLayout>
      <main className="flex min-h-[80svh] items-center justify-center px-5 pb-20 pt-36 text-center" id="conteudo">
        <div>
          ...
          <a className="mt-8 inline-flex bg-[#d4af37] px-7 py-4 text-xs font-black uppercase tracking-[0.15em] text-[#0d0d0d] transition-colors hover:bg-[#f3e5ab]" href="/">
