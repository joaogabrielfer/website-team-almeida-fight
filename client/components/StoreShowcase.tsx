...
export function StoreShowcase() {
  return (
    ...
    >
      ...
      <img alt="Peças oficiais Almeida Fight" className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.025]" src={STORE_IMAGES.showcase} />
