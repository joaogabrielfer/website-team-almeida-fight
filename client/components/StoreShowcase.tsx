  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 hidden grid-cols-[1.14fr_0.86fr] gap-px bg-black/25 sm:grid">
        <img alt="Camisa oficial preta Almeida Fight" className="h-full w-full object-contain p-2 transition-transform duration-700 group-hover:scale-[1.025]" src={STORE_IMAGES.officialShirt} />
        <div className="grid grid-rows-2 gap-px">
          <img alt="Short de Muay Thai Almeida Fight" className="h-full w-full object-contain p-2 transition-transform duration-700 delay-75 group-hover:scale-[1.035]" src={STORE_IMAGES.muayThaiShorts} />
          <img alt="Camisa oficial branca Almeida Fight" className="h-full w-full object-contain p-2 transition-transform duration-700 delay-100 group-hover:scale-[1.035]" src={STORE_IMAGES.personalizedShirt} />
        </div>
      </div>
